#!/usr/bin/env python3
"""Pipeline Feeder — generates traffic for testing L7→L3 pipeline.

Sends to SmartRouter (:9932):
  - kind:39002 (content) with agent metrics — every 10 seconds
  - kind:30000 (payment) — every 60 seconds
  - kind:39010 (DAO vote) — every 120 seconds
"""
